...
public class DockContract {
    ...
    public static final Uri DOCK_PROVIDER_CONNECTED_URI = new Uri.Builder().scheme("content")
    ...
    public static final Uri DOCK_PROVIDER_SAVED_URI = new Uri.Builder().scheme("content").
             authority("com.google.android.apps.dreamliner.provider").
             appendPath("saved").build();
