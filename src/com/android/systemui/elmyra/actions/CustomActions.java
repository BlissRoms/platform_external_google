...
public class CustomActions extends Action {
    ...
    static {
        sCanTurnOnScreenActions.add(ActionHandler.SYSTEMUI_TASK_GOOGLE_NOW_ON_TAP);
    ...
    static {
        ...
        sActionsCanExecuteWhenScreenOff.add(ActionHandler.SYSTEMUI_TASK_SCREENON);
    }
    ...
    public void onTrigger(DetectionProperties detectionProperties) {
        ...
        if (!isScreenOn) {
            if (actionCanTurnOnScreen(action)) {
                ActionHandler.performTask(getContext(), ActionHandler.SYSTEMUI_TASK_SCREENON);
